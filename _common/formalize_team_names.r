...
formalizeTeamNames = function(dt) { 
	...
	for (var in vars) {
		...
		tmp[tmpVar=='new-england' | tmpVar=='New England Revolution' | tmpVar=='New England Rev.', tmpVar:='New England']
		...
		tmp[tmpVar=='seattle' | tmpVar=='Seattle' | tmpVar=='Seattle Sounders FC', tmpVar:='Seattle Sounders']
